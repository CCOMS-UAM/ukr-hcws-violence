...
ds_ua <- 
  ...
  ds_ua |> 
  drop_na(scdm_2_rec) |> 
  filter(scdm_1_rec != "Less than 20 years old")
```
...
rm(glme_se_ratios, make_stratified_table, run_crude_glm, run_glm_adj)
```
...
# get data
exp_reg <- readRDS("out/exposure_regions.rds") |> 
  pivot_longer(
...
out_reg <- readRDS("out/outcome_regions.rds") |> 
  pivot_longer(
